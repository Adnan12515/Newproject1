...
const page = () => {
  return (
    <div className='pl-5 py-4 mt-2 mb-3'>
        <h1 className="text-2xl font-bold py-3">
                    Contact<span className="text-yellow-500">Us:</span></h1>
                    ...
                    <p className='font-normal text-xl text-yellow-400 py-2 space-x-2 pl-3'>Before you contact us, please start with our FAQ page. We've probably already answered your question there.
                        ...
                        Tuckshop.com
                        <br />
                        D-10 Paradise Appartment
                        <br />
                        Near Sindh Assmebly, khi· 74200
                        <br />
                        Email Addressed:
                        <br /> 
                        </p>
                        <p className='text-red-300 font-semibold text-2xl pl-3'>awan_a1985@yahoo.com
                        <br />
                        Cell Number
                        <br />
                        +923432121200
